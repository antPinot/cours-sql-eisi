...
SELECT REF, DESIGNATION FROM ARTICLES WHERE PRIX > 2;
...
SELECT * FROM ARTICLES WHERE NOT (PRIX BETWEEN 2 AND 6.25) AND ID_FOU = (SELECT * FROM FOURNISSEUR WHERE NOM = 'Française d''Imports')
...
SELECT * FROM ARTICLES WHERE ID_FOU = (SELECT * FROM FOURNISSEUR WHERE NOM = 'Française d''Imports') OR ID_FOU = (SELECT * FROM FOURNISSEUR WHERE NOM = 'Dubois et Fils')

-- g. En utilisant l'opérateur IN, réalisez la même requête que précédemment
SELECT * FROM ARTICLES WHERE ID_FOU = (SELECT * FROM FOURNISSEUR WHERE NOM IN ('Française d''Imports', 'Dubois et Fils')
...
SELECT * FROM ARTICLES WHERE ID_FOU NOT IN (SELECT * FROM FOURNISSEUR WHERE NOM IN ('Française d''Imports', 'Dubois et Fils')
